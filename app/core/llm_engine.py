...
def call_gemini_api(prompt: str, model_name: str = DEFAULT_MODEL) -> str:
    ...
    # Detect token type: Bearer token vs Standard API Key
    is_bearer_token = api_key.startswith("AQ.") or api_key.startswith("ya29.")
    ...
    for m in models_to_try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning(f"Model '{m}' call returned status {response.status_code}, trying next model...")
